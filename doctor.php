...
<div class="container"> 
 ...
 <form class="form-horizontal" action="logd.php" method="get">
...
$sqls="SELECT patient_comment.P_EMAIL,patient_comment.P_COMMENT from patient_comment";
...
echo "<tr>";
echo"<td>"."<b>"."<center>"."Patient Email"."</td>"."<td>"."<b>"."<center>"."Patient Problem" ."</td>";
echo "</tr>";
...
echo "<tr>";
  echo "<td>".$row['P_EMAIL']."</td>"."<td>".$row['P_COMMENT']."</td>";
...
<br>
              ...
              <center>
<h1>Help desk by answer question according patient problem</h1>
<center>
<?php 
...
$sqls="SELECT patient_account.NAME,patient_account.EMAIL ,patient_problem.PROBLEM from patient_account,patient_problem where EMAIL=P_EMAIL";
...
echo "<br>";
echo "<center>";
echo "<b>"."YOU CAN GIVE THEIR SOLUTION";
echo "<br>";

echo "<br>";
echo "<table class='tab' border='5px' align='center' width='1000'>";

echo "<tr>";
echo "<td align='center'>"."<b>"."NAME"."</td>"."<td align='center'>"."<b>"."EMAIL"."</td>"."<td align='center'>"."<b>"."PROBLEM"."</td>"."<td align='center'>"."<b>"."SOLUTION"."</td>";
echo "</tr>";
while($row=mysql_fetch_array($result))
{
echo "<tr>";
  echo "<td>".$row['NAME']."</td>"."<td>".$row['EMAIL']."</td>"."<td>".$row['PROBLEM']."</td>";

  echo "<td align='center'> <a href='d_comment_form.php? EMAIL=".$row['EMAIL']."'>SOLUTION </a>  </td>"." "; 
