    ...
    <a class="dropdown-item active-hover" href="doctor_ac.php">Doctor Account</a>
      ...
      <div class="container-fluid pl-0 pr-0">
          ...
          <div class="table-primary" id="table">
              ...
              <form class="form-horizontal"  action="patient_problem.php"  method="post">
              
               <div class="control-group">
                <label class="control-label" for="Email"> Email:</label>
                <div class="controls">
                  <input type="Email" id="Email" name="Email" class="form-control"  placeholder="Enter Your Email Again" class="input-large" required="">
                </div>
              </div>
