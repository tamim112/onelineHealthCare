...
<em>minimum 6 characters</em>
      ...
      <h5>Already have an account? or Create</h5>
      <center>
          ...
          <div class="row ml-0 mr-0">
             ...
             <div class="col-md-2 col-sm-12 col-xl-2 pl-0 pr-0">
              ...
              <form class="form-horizontal" action="" method="get">
               ...
               <div class="control-group">
               <label class="control-label" for="doctor_text"> <h4>Write your Suggetion:</h4></label>
               <div class="controls">
               <textarea name="doctor_text" cols=100 rows=8  placeholder= "write your Suggetion"> </textarea>
               </div>
             </div>
             <center>
            <button type ="submit" id="send" name="doctor_text" class="btn btn-primary">Submit</button>
        </center>
            </form>
