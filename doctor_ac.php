...
<center>
          <div class="table-primary" id="table">
              <form class="form-horizontal" action="ac_dc.php " method="post">
              <fieldset>
              <!-- Sign Up Form -->
              <!-- Text input-->
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="Name" name="Name" class="form-control" type="text" placeholder="Enter Your Full Name" class="input-large" required="">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="Email" id="Email" name="Email" class="form-control"  placeholder="Enter Your Email" class="input-large" required="">
                </div>
              </div>
              ...
              <div class="control-group">
                <label class="control-label" for="Designation">Enter Your Designation:</label>
                <div class="controls">
                  <input id="Designation" name="Designation" class="form-control" type="text" placeholder="Enter Your Designation" class="input-large" required="">
                </div>
              </div>


             <div class="control-group">
                <label class="control-label" for="special">Specialist:</label>
                <div class="controls">
                  <input id="special" name="special" class="form-control" type="text" placeholder="Enter Your Speciality" class="input-large" required="">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input id="Address" name="Address" class="form-control" type="text" placeholder="Enter Your City Name" class="input-large" required="">
                </div>
              </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <center>
                  <button id="confirmsignup" type="Submit" name="confirmsignup" class="btn btn-success">Sign Up</button> </center>
                </div>
              </div>
              </fieldset>
              </form>
