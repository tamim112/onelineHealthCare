  ...
  <a class="dropdown-item active-hover" href="patient_ac.php">Patient Account</a>
    <a class="dropdown-item active-hover" href="doctor_ac.php">Doctor Account</a>
      ...
      <div class="container-fluid pl-0 pr-0">
        ...
        <form class="form-horizontal" action="ac_pn.php " method="post">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input  type="password"id="password" name="password" class="form-control" placeholder="********" class="input-large" required="" >
