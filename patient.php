...
$sqls="SELECT * FROM patient_account";
...
$row=mysql_fetch_array($result);
     ...
     echo "<tr>";
  echo "<td>" ."<b>"."NAME:-"."</td>". "<td>".$row['NAME']."</td>";
  ...
  echo "</tr>"."<br>";
               ...
               ?>
                  ...
                  <center>
<h1>Help desk by asking question according doctor Speciality</h1>
<center>
               <div class="inbox">
               <h3>INBOX:-</h3>
...
$sqls="SELECT doctor_comment.D_EMAIL,doctor_comment.D_COMMENT from doctor_comment";
...
echo "<br><center>";
echo "<table border='5px' align='center' width='1000'>";

echo "<tr>";
echo"<td>"."<b>"."<center>"."Doctor Email"."</td>"."<td>"."<b>"."<center>"."Doctor Solution" ."</td>";
echo "</tr>";
...
echo "<tr>";
  echo "<td>".$row['D_EMAIL']."</td>"."<td>".$row['D_COMMENT']."</td>";
...
<div class="ss">
      <center>
     <a href="patien_form.php" ><button type="button" class="butto"  class="btn btn-primary"> Problem</button></a>
        </center>
      </div>
               </center>
...
$sqls="select * from doctor_account";
...
echo "<br>";
echo "<center>";
echo "<b>"."YOU CAN ASK FOR SOLUTION";
echo "<br>";

echo "<br>";
echo "<table class='tab' border='3px' width='1000' align='center'>";

echo "<tr  height='50px'>";
echo "<td align='center' >"."<b>"."Dr.NAME"."</td>"."<td align='center'>"."<b>"."EMAIL"."</td>"."<td align='center'>"."<b>"."DESIGNATION"."</td>"."<td align='center'>"."<b>". 
"SPECIALITY"."</td>"."<td align='center'>"."<b>". 
"PROBLEM"."</td>";
echo "</tr>";
...
{
echo "<tr>";
  echo "<td>".$row['NAME']."</td>"."<td>".$row['EMAIL']."</td>"."<td>".$row['DEG']."</td>"."<td>".$row['SPECIALIST']."</td>";

  echo "<td align='center'> <a href='p_comment_form.php? EMAIL=".$row['EMAIL']."'>PROBLEM </a>  </td>"." "; 
  
  
// <a href='#?id=".$row['Id']."'></a>  <button class='jo active' border='10' width='200'></button>
// <a href='#?id=".$row['Id']."'> </a> 
  echo "</tr>";
}
echo "</table>";
